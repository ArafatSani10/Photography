...
//     return (
//         <motion.nav
//             className={`fixed top-0 left-0 w-full z-50 transition-all duration-500  ${scrollingDown ? "-translate-y-full" : "translate-y-0"
//                 } ${isScrolled
//                     ? "bg-white/90 shadow-2xl shadow-black/5 "
//                     : "bg-transparent"
//                 }`}
//             initial={{ y: -100 }}
//             animate={{ y: 0 }}
...
//                         src={
//                             isScrolled
//                                 ? "https://i.ibb.co.com/k6Kd5jkB/chitromul11.png"
//                                 : "https://i.ibb.co.com/Cs75xXFM/chitromul.png"
//                         }
//                         alt="Logo"
...
//                                 <NavLink
//                                     to={item.path}
//                                     // *** IMPORTANT FIX: Add 'inline-flex' or 'inline-block' to contain the line properly ***
//                                     className={({ isActive }) =>
...
//                                     }
//                                 >
//                                     {/* The text content must be inside a span to control its layering */}
