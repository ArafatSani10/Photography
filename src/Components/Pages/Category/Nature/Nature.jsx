...
const natureImagesData = [
    ...
    { id: 20, category: "Nature", image: "/Nature/9.jpg" },
    { id: 21, category: "Nature", image: "/Nature/10.jpg" },
    { id: 22, category: "Nature", image: "/Nature/11.jpg" },
    { id: 23, category: "Nature", image: "/Nature/12.jpg" },
...
const Nature = () => {
    ...
    const photoVariants = {
        ...
        visible: { opacity: 1, rotate: 0, y: 0, transition: { duration: 0.7, ease: "easeOut" } }
    };
