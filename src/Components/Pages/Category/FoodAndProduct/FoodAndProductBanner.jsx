...
const FoodAndProductBanner = () => {
    // Tomar dewa banners data ekhane
    const banners = [
        {
            image: "https://plus.unsplash.com/premium_photo-1694166713270-da1164385b19?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170",
            title: "Food & Product Photography",
            text: "We make your products shine. We focus on **texture, detail, and lighting** to create mouth-watering food visuals and high-impact commercial images that drive sales and elevate your brand..",
        },
...
export default FoodAndProductBanner;