...
const EventCultureBanner = () => {
    // Tomar dewa banners data ekhane
    const banners = [
       {
    image: "https://plus.unsplash.com/premium_photo-1664303677453-ca2ad8f7dd8d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8TGl2ZSUyMEV2ZW50JTIwQ3VsdHVyZXxlbnwwfHwwfHx8MA%3D%3D",
    title: "Live Event Culture",
    text: " Authentic, vibrant photography that captures the true spirit of your events and cultural moments..",
},
...
export default EventCultureBanner;