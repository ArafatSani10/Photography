...
const FashionAndPortraitBanner = () => {
    // Tomar dewa banners data ekhane
    const banners = [
        {
            image: "https://images.unsplash.com/photo-1718964313073-f809eb6a9f90?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1170",
            title: "Fashion & Portrait Photography ",
            text: " We specialize in capturing your **unique style and personality**. Our fashion and portrait work focuses on creating striking, editorial-quality images that tell a compelling story.",
        },
...
export default FashionAndPortraitBanner;