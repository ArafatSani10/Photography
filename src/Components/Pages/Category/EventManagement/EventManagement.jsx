...
const eventManagementImages = [
    { id: 1, src: "/EventManage/DSC025173.jpg", alt: 'Grand Wedding Stage Setup' },
    { id: 2, src: "/EventManage/DSC03266.JPG", alt: 'Corporate Event Lighting' },
    { id: 3, src: "/EventManage/IMG-20250117-WA0017.jpg", alt: 'Exhibition Stall Design' },
    { id: 4, src: "/EventManage/IMG-20250514-WA0010.jpg", alt: 'Concert Crowd View' },
    { id: 5, src: "/EventManage/IMG-20250514-WA0024.jpg", alt: 'Birthday Party Decoration' },
    { id: 6, src: "/EventManage/IMG-20250514-WA0029.jpg", alt: 'Gala Dinner Table Setting' },
    { id: 7, src: "/EventManage/IMG-20250514-WA0036.jpg", alt: 'Product Launch Venue' },
    { id: 8, src: "/EventManage/IMG-20250514-WA0037.jpg", alt: 'Outdoor Festival Setup' },
]; 
    ...
    return (
        ...
        >
            ...
            <p className="text-gray-600 text-lg">
                No **Event Management** images have been added to the portfolio yet. Please check back later!
            </p>
        </motion.div>
    );
};
